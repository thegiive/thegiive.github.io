...
過去幾年，OpenAI 的策略是「toC 霸榜」——追求基準測試第一、Fun，甚至有人會造成情感依賴，病毒式傳播、用戶增長。但 GPT-5.2 的優化方向透露了不同的訊號：**更嚴格的指令遵循、長對話穩定性、大 context 下的一致性、減少幻覺**。這些都不是讓普通用戶驚艷的功能，但卻是企業客戶最在意的特性。看起來 OpenAI 這一年商業化的轉型，被逼著他們從 GPT-4o 的幽默靈動，變成了 GPT-5.2 的 toB 取向。
