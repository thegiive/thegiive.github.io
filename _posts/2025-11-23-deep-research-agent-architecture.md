---
layout: post
title: "從 Simple RAG 到 Autonomous Agent 之間的「恐怖谷」— 我們如何用 System 2 思維突破瓶頸"
date: 2025-11-23
categories: AI Agent Architecture
tags: [AIAgent, DeepResearch, LLM, ArchitecturalDesign, System2Thinking, ProductionAI]
author: Wisely Chen
excerpt: "Deep Research 架構通過引入 System 2 思維的「Critic 節點」，解決傳統 Agent 無法自我檢查的根本問題。本文分析這一架構的設計、必要條件與適用場景。"
---

![Deep Research 標題圖](/assets/images/deep-research-title-logo.png)

## 第一段: Hook (Uncanny Valley 痛點)
...
## 第二段: 典範轉移 (Prompt Engineering → Architectural Design)
...
![決策樹圖](/assets/images/decision-tree-diagram.png)

---

## 這是「Agent 模式系列」的第三篇:

- Part 1: Workflow vs ReAct — 確定性 vs 靈活性
- Part 2: ReAct vs Plan-Execute — 摸著石頭過河 vs 高鐵規劃
- Part 3: Deep Research — 為 Agent 裝上「System 2」大腦
