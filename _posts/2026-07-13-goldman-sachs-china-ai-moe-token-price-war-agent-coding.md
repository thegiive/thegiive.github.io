...
**第二層：基礎設施成本。** 這是 GS 報告沒有深入展開、但可能是最被低估的一層。中國的推理基礎設施成本結構跟美國完全不同：電力方面，中國資料中心的工業電價大約是美國的 1/3 到 1/2，部分地區還有地方政府的 AI 產業電價補貼；硬體方面，華為昇騰晶片的採購成本遠低於 NVIDIA H100/H200，而且不受出口管制影響，GLM 5.2 就是在 10 萬張昇騰上訓練出來的，零 NVIDIA 依賴；人才方面，中國 AI 工程師的薪資中位數大約是矽谷同級別的 1/3 到 1/2。這些加起來，即使同一個架構、同一個激活比例，中國廠商的每 token 推理成本就已經比美國低了一截。

**第三層：定價策略。** 美國 SOTA 模型定價 $4-8/百萬 token，裡面包含了高毛利（OpenAI 的 API 毛利率被估計在 50% 以上）；中國模型定價 $1 甚至更低，GS 測算是虧損狀態。一邊在賺錢，一邊在貼錢搶市場。

**三層疊起來才有 4-8 倍的價差。** 架構是一層，基礎設施是一層，定價意願是一層。即使補貼結束、定價回歸理性，前兩層的成本優勢不會消失——電力不會漲到美國水準，昇騰不會變成 H100 的價格，工程師薪資不會對齊矽谷。這才是「結構性」三個字的真正含義。
...
1. **4-8 倍的價差是三層結構疊出來的：架構激進度、基礎設施成本、定價策略。** 大家都用 MoE，但中國壓到 3-5% 激活；電力是美國的 1/3-1/2，硬體用昇騰不用 H100，人才成本也低；再疊上 -30% 到 -39% 的虧損定價。補貼會結束，但前兩層——架構和基礎設施——不會消失。做成本規劃時，不要假設價差會收斂到 1-2 倍，結構性差距可能長期維持在 3-4 倍。
