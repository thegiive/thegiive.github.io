---
layout: post
title: "Moltbot 安全加固實戰：AI Agent 四層縱深防禦完整指南"
...
description: "不需要是資安專家，只需要願意花一個下午認真讀文件。這篇整理 Moltbot 社群的四層縱深防禦實戰經驗：Isolation、Quarantine、Rollback、Transparency。涵蓋 AI Agent Security、Prompt Injection Defense、LLM Agent Security 與 Agentic Security 完整框架。"
...
**作者：** Wisely Chen
**日期：** 2026 年 1 月
**系列：** AI Agent Security 實戰觀察
**關鍵字：** AI Agent Security, Prompt Injection, LLM Agent Security, Agentic Security, Security Hardening

---

## 目錄

- [背景：為什麼 Moltbot 需要 Security Hardening？](#背景為什麼-moltbot-需要-security-hardening)
- [AI Agent Security Framework：四層縱深防禦](#ai-agent-security-frameworkmoltbot-四層縱深防禦)
- [第一層 Isolation：限制爆炸半徑](#第一層-isolation限制-ai-agent-被入侵時的爆炸半徑)
- [第二層 Quarantine：Prompt Injection Defense](#第二層-quarantineprompt-injection-defense-與內容隔離)
- [第三層 Rollback：損害復原機制](#第三層-rollbackai-agent-出事後的損害復原機制)
- [第四層 Transparency：早期預警系統](#第四層-transparencyllm-agent-security-的早期預警系統)
- [讓 Moltbot 幫你做這件事](#讓-moltbot-幫你做這件事)
- [常見問題 Q&A](#常見問題-qa)
- [這篇文章適合誰？](#這篇文章適合誰)
- [延伸閱讀](#延伸閱讀)
...
前篇文章 [500 台 AI 助理裸奔公網：Moltbot Security Disaster 與預設安全風險](/moltbot-security-disaster/) 揭露了 Moltbot 的預設配置災難。這篇是續集 — 從問題到解決方案。
...
在開始實作之前，先理解整體防禦思路。AI Agent Security 不是單點防護，而是**四層縱深防禦**：

![AI Agent Security 四層縱深防禦架構](/assets/images/ai-agent-security-slide-02.png)
...
![AI Agent Isolation 與爆炸半徑控制示意圖](/assets/images/ai-agent-security-slide-09.png)
...
![Prompt Injection 與內容隔離防禦流程](/assets/images/ai-agent-security-slide-03.png)

**核心問題：外部輸入能做什麼？**

這是大多數人會跳過的步驟，但可能是**最重要的一層**。Prompt Injection 是目前 AI Agent 最常見、也最容易被忽略的攻擊手法，尤其在自動處理郵件、網頁與文件時。

這一層的理論基礎來自 Google DeepMind 提出的 [CaMeL 雙層 Agent 架構](/camel-privileged-quarantined-agent/)——核心概念是「讀資料」和「做動作」永遠分開。
...
![AI Agent Rollback 回滾能力示意圖](/assets/images/ai-agent-security-slide-05.png)
...
![AI Agent Transparency 透明告知與早期預警](/assets/images/ai-agent-security-slide-07.png)
...
- 正在導入 AI Agent（Moltbot、Claude Code、Cursor、Copilot）的**工程師**
- 擔心 Prompt Injection、Agent 失控的**技術主管**
- 想把 AI Coding 從「能跑」變成「可控、可回滾」的**開發團隊**
- 對 LLM Agent Security 有興趣的**資安從業人員**
- 希望理解 Agentic Security 框架的**架構師**
