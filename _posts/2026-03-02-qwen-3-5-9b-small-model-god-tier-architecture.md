...
9B 我已經用 Ollama 拉下來跑起來了，基本的對話和推理確實很流暢。但之前在[本地 LLM 處理 Excel](/local-llm-excel-code-interpreter/) 那篇文章裡用 Gemma 3 跑的那些場景——Excel 解析、結構化資料提取、多步驟推理——這些我還沒有拿 Qwen 3.5-9B 重新跑過。
