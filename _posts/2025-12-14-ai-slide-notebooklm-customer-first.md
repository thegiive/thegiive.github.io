...
以下是一個範例，可以看到底色是很類似的企業主體色
但是 NotebookLM 很棒的地方就是他連底圖 , 還會有些許小變化 

![客製化簡報範例 1](/assets/images/customer-first-example-1.png)

![客製化簡報範例 2](/assets/images/customer-first-example-2.png)
