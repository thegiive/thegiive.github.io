...
2013 年，Jeff Dean 做了一個[餐巾紙計算](https://officechai.com/ai/jeff-dean-on-how-a-compute-intensive-speech-recognition-feature-made-google-develop-its-own-tpus-in-2015/)：如果每個 Android 用戶每天用三分鐘語音搜尋，Google 需要把全球資料中心的算力翻倍。他的結論不是「我們買更多 CPU」，而是「我們自己做晶片」。2015 年，TPU 在內部上線。從設計到部署，[15 個月](https://trendvector.substack.com/p/ten-years-of-tpu-how-google-built)。
