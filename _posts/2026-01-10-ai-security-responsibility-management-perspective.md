...
description: "AI 資安，不是 IT 問題，而是數位員工的治理問題。當第一個數位員工被納入組織體系，治理卻仍停留在工具與系統時代——這才是企業真正的結構性風險。"
...
- [最好最貴的資安工具不是答案](/ai-agent-security-game-changed/)——Guardrails 註定擋不住語言層面的攻擊
...
- [有些事情需要技術投資，但用最簡單的 PostgreSQL 即可](/camel-postgresql-implementation-memory-permission-db-layer/)——不需要重建系統，RLS 就能讓某些事「技術上做不到」
...
這就是為什麼 [CaMeL 架構](/camel-postgresql-implementation-memory-permission-db-layer/) 要把「讀資料」和「做動作」徹底分開——因為有些事情，AI 可以建議，但不能執行。
...
如果風險從來沒有被治理層承認，它就一定會以 [影子 AI](/least-privilege-fde-shadow-it-shadow-ai/) 或失控的形式出現。
...
[CaMeL](/camel-postgresql-implementation-memory-permission-db-layer/)、PostgresSQL RLS、權限分層、審計設計，其實都不是在「防 AI」，而是在**具體化這三個治理決策**。
...
AI 不會等待治理成熟；[法律](/taiwan-ai-basic-act-engineering-perspective/)也不會接受「我們還在研究」作為理由。
...
| [數字人主播學貓叫：一場 Prompt Injection 的現場直播](/ai-digital-anchor-prompt-injection-meow/) | AI 失控可以有多荒謬？ |
| [台灣 AI 基本法：工程師視角的解讀](/taiwan-ai-basic-act-engineering-perspective/) | 法律如何定義 AI 的責任？ |
| [AI Coding 工具的資安風險](/ai-coding-tool-security-risk-prompt-injection-rce/) | 開發工具本身的風險在哪？ |
