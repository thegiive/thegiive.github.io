...
反過來，**drafter 猜不準的場景**也很好懂：「我覺得這個方案最大的問題是\_\_\_」這種開放式創作，後面是什麼字主模型自己都還沒決定，drafter 怎麼可能猜對？
...
2. 重算 [on-prem 三條路](/ai-coding-on-prem-three-paths/) 的 token-per-dollar
